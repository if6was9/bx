...
public class CsvExportTest extends BxTest {
  ...
  public void testAsResultSetExtractor() {
    ...
    t.getJdbcClient()
        ...
        .query(new BasicCsvExport().withConfig(c -> c.quoteStrategy(QuoteStrategies.ALWAYS)).to(baos).newResultSetExtractor());
  ...
  public void testFluent() {
    ...
    String output =
        BasicCsvExport.from(getDataSource())
            .sql(
                c ->
  ...
  public void testGzip() throws IOException {
    ...
    t.getJdbcClient()
        .sql("select flight,ac_reg as ac_reg from adsb limit 10")
        .query(new BasicCsvExport().withConfig(c -> c.quoteStrategy(QuoteStrategies.ALWAYS)).to(f).newResultSetExtractor());
  ...
  public void testVariants() throws IOException {
    ...
    String csv1 =
        BasicCsvExport.from(t.getDataSource())
