...
public class JsonTest {
  ...
  public void testHash() {
		...
		Assertions.assertThat(Json.hash(n)).isEqualTo("74234e98afe7498fb5daf1f36ac2d78acc339464f950703b8c019892f982b90b");
		Assertions.assertThat(Json.hash(NullNode.getInstance())).isEqualTo("74234e98afe7498fb5daf1f36ac2d78acc339464f950703b8c019892f982b90b");
		Assertions.assertThat(Json.hash(Json.readTree(""))).isEqualTo("74234e98afe7498fb5daf1f36ac2d78acc339464f950703b8c019892f982b90b");
		Assertions.assertThat(Json.hash(Json.readTree("123"))).isEqualTo("a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3");
	
		Assertions.assertThat(Json.hash(Json.readTree("\"hello\""))).isEqualTo("5aa762ae383fbb727af3c7a36d4940a5b8c40a989452d2304fc958ff3f354e7a");
		
		
		Assertions.assertThat(Json.hash(Json.readTree("true"))).isEqualTo("b5bea41b6c623f7c09f1bf24dcae58ebab3c0cdd90ad966bc43a45b44867e12b");
		...
		Assertions.assertThat(val).isEqualTo("7a38bf81f383f69433ad6e900d35b3e2385593f76a7b7ab5d4355b8ba41ee24b");
		
		ObjectNode on = Json.createObjectNode();
		on.put("foo", "bar");
		
		Assertions.assertThat(Json.hash(on)).isEqualTo("7a38bf81f383f69433ad6e900d35b3e2385593f76a7b7ab5d4355b8ba41ee24b");
	
		
		tools.jackson.databind.node.ArrayNode an = Json.createArrayNode();
		
		Assertions.assertThat(Json.hash(an)).isEqualTo("4f53cda18c2baa0c0354bb5f9a3ecbe5ed12ab4d8e11ba873c2f11161202b945");
		...
		Assertions.assertThat(Json.hash(an)).isEqualTo("2caeec3b3bacb4586be07bc06936bece287d217ec5ac4a41520d936991f30b41");
  ...
  public void testRemove() {
	  ...
	  java.util.List<String> toRemove = n.propertyNames().stream().filter(p->rand.nextBoolean()).toList();
